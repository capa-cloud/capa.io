...
{{% pageinfo %}}
Capa 为 Java 应用提供统一的云运行时 API，并通过可替换的 SDK 组件适配不同基础设施。
{{% /pageinfo %}}
...
+ Configuration Center (Configuration动态配置)
...
![Capa SDK 分层](https://raw.githubusercontent.com/capa-cloud/capa-java/master/docs/capa-design/capa-layer.PNG)
...
[将遗留中间件 SDK 无感迁移到 Capa](https://github.com/reactivegroup/sigs/issues/18)
...
The Java SDK for Capa is built using [Project Reactor](https://github.com/reactor/reactor-core). It provides an asynchronous API for
...
the [Mono](https://github.com/reactor/reactor-core/blob/main/docs/modules/ROOT/pages/coreFeatures/mono.adoc) publisher object. Nothing
