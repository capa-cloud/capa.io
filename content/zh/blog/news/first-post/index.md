---
date: 2021-12-31
title: "Capa(Cloud-Application-API)：架起应用混合云开发的桥梁"
linkTitle: "Announcing Docsy"
description: "让代码实现"一次编写，随处运行"。 借助Capa体系，使你的Java应用在改动量较小的情况下，拥有跨云、混合云运行的能力。"
author: KevinTen ([@kevinten10](https://github.com/kevinten10))
---
