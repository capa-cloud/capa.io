...
故 Capa 在 Redis 领域定义了一套 [Native Redis API](https://github.com/capa-cloud/cloud-runtimes-jvm/blob/master/cloud-runtimes-api/src/main/java/group/rxcloud/cloudruntimes/domain/nativeproto/NativeRedisRuntimes.java)。
